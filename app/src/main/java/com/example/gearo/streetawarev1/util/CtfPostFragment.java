...
public class CtfPostFragment extends Fragment implements SelectPhotoDialog.OnPhotoSelectedListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_ctf_post, container, false);
    ...
    private void init(){
        ...
        mPostImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog.setTargetFragment(CtfPostFragment.this, 1);
    ...
    public class BackgroundImageResize extends AsyncTask<Uri, Integer, byte[]>{
        ...
        protected byte[] doInBackground(Uri... params) {
            ...
            if(mBitmap == null){
                try {
                    //if the value is a Uri then we first convert to a bitmap
                    //The line below is done in the bg as it can be very slow otherwise
                    mBitmap = MediaStore.Images.Media.getBitmap(getActivity().getContentResolver(), params[0]);
                }catch (IOException e){
                    Log.e(TAG, "DoInBackground: IOException: " + e.getMessage());
                }
            }
            //if its a bitmap or once the uri has been converted to a bitmap then we simply resize based on the quality
